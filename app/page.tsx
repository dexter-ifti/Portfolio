        ...
        <div className="mt-8">
          ...
          <div className="flex flex-col">
            {Projects.slice(0, 5).map((project) => (
              ...
              >
                <article className="flex w-full items-center justify-between gap-3 py-3">
                  <div className="min-w-0 flex-1">
                    <h1 className="break-words text-lg font-medium leading-[1.3em] text-left text-gray-300 group-hover:text-white">
                      {project.name}
                    </h1>
                  </div>
                  <div className="min-w-4 flex-1 border-y border-neutral-700 transition duration-150 opacity-80 group-hover:border-white"></div>
                  <AiOutlineRight
