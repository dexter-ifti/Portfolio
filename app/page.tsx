      ...
      <div className="flex mt-8 flex-col max-w-[512px] mx-auto p-5 lg:p-0">
        <div className="container">
          ...
          <p className="mt-3 text-xl text-gray-400">
            I&apos;m Taha, a {age} year old developer living in India. I am
          ...
          <p className="mt-3 text-xl text-gray-400">
            ...
            <Badge href="https://expressjs.com">
              <svg
                width="14"
                height="14"
                aria-label="Express.js logomark"
                viewBox="0 0 180 180"
                fill="none"
        ...
        <div className="mt-5">
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap gap-2">
              {["HTML5", "CSS3", "JavaScript", "TypeScript", "React JS", "Tailwind CSS"].map((skill) => (
                <span
                  key={skill}
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap gap-2">
              {["Node.js", "Express.js", "HonoJS", "MongoDB", "PostgreSQL", "Prisma ORM", "Mongoose"].map((skill) => (
                <span
                  key={skill}
